...
public class TermVectorField extends Field {
    ...
    public TermVectorField(String name, Reader reader) {
        super(name, reader, TYPE_NOT_STORED);
    }

    public TermVectorField(String name, String value, Store store) {
        super(name, value, store == Store.YES ? TYPE_STORED : TYPE_NOT_STORED);
    }

    public TermVectorField(String name, TokenStream stream) {
