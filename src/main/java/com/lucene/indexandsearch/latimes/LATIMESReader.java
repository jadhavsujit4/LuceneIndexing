...
public class LATIMESReader {
    ...
    public static List<Document> loadLATIMESDocs(String fbisDirectory) throws IOException {
    ...
    private static void LATIMESRead() throws IOException {
        ...
        for (Element doc : list) {
            ...
            if (doc.getElementsByTag(LATIMESTags.BYINE.name()) != null)
                latimesData.setByLine(removeUnnecessaryTags(doc, LATIMESTags.BYINE));
